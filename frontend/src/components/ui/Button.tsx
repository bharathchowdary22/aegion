...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: "bg-[#FFF4EA] text-[#E85000] hover:bg-[#FFE6D4] border border-[#FFD7BA] active:scale-[0.98]",
    outline: "bg-white border border-[#F1E4DA] text-[#171717] hover:bg-[#FFF8F3] hover:border-[#FFD2B2] active:scale-[0.98]",
    ghost: "text-[#6B7280] hover:text-[#171717] hover:bg-[#FFF8F3] active:scale-[0.98]",
    danger: "bg-red-50 text-red-600 border border-red-200 hover:bg-red-100 active:scale-[0.98]",
    // `dark` variant preserved for compatibility — converted to light orange secondary
    dark: "bg-[#FFF4EA] text-[#E85000] border border-[#FFD7BA] hover:bg-[#FFE8D6] active:scale-[0.98] shadow-sm",
  };
